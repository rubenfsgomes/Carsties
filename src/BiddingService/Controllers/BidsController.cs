namespace BiddingService.Controllers
{
    ...
    /// <summary>
    /// Defines the <see cref="BidsController" />
    /// </summary>
    [ApiController]
    ...
    public class BidsController : ControllerBase
    {
        ...
        /// The PlaceBid
        /// </summary>
        /// <param name="auctionId">The auctionId<see cref="string"/></param>
        /// <param name="amount">The amount<see cref="int"/></param>
        /// <returns>The <see cref="Task{ActionResult{BidDto}}"/></returns>
        [Authorize]
        [HttpPost]
        ...
        /// <summary>
        /// The GetBidsForAuction
        /// </summary>
        /// <param name="auctionId">The auctionId<see cref="string"/></param>
        /// <returns>The <see cref="Task{ActionResult{List{BidDto}}}"/></returns>
        [HttpGet("{auctionId}")]
